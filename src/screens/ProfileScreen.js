...
const ProfileScreen = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      if (user && user.email === process.env.REACT_APP_DEMO_MAIL) {
        window.alert(
          'The profile gets updated here! This is just a demo! No profile updated!'
        );
      } else {
        updateUser();
      }
  ...
  const deleteResume = async () => {
    if (window.confirm('Are you sure you want to delete the resume?')) {
      if (user && user.email === process.env.REACT_APP_DEMO_MAIL) {
        window.alert(
          'The resume gets deleted here! This is just a demo! No resume deleted!'
        );
      } else {
        setResume({});
    ...
    <Container>
      <Row className="my-3">
        <Form onSubmit={submitHandler}>
          <Row>
            <h2 className="p-3" style={{ width: '50%' }}>
              <u>User Profile</u>
            </h2>
            <Form.Group
              as={Col}
          ...
          <Row className="my-3 py-3">
            <Form.Group as={Col} controlId="email" md={4} className="my-1">
            ...
            <Form.Group as={Col} controlId="mobile" md={4} className="my-1">
            ...
            <Form.Group as={Col} controlId="telephone" md={4} className="my-1">
          ...
          <Row className="my-3 py-3">
            <Form.Group as={Col} controlId="zip" md={3} className="my-1">
            ...
            <Form.Group as={Col} controlId="city" md={3} className="my-1">
            ...
            <Form.Group as={Col} controlId="state" md={3} className="my-1">
            ...
            <Form.Group as={Col} controlId="country" md={3} className="my-1">
          ...
          <Row className="my-3 py-3">
            <Form.Group as={Col} controlId="password" md={6} className="m-2">
