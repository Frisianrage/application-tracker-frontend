...
const EmployerDetailsScreen = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (user && user.email === process.env.REACT_APP_DEMO_MAIL) {
      window.alert(
        'This employer gets updated here! This is just a demo! No new emlpoyer updated!'
      );
    } else {
      updateEmployer();
    }
      ...
      <Row>
        <Form onSubmit={submitHandler}>
          ...
          <Row>
            ...
            <Form.Group controlId="address" md={6}>
            ...
            <Form.Group controlId="addressTwo" md={6}>
            ...
            <Form.Group as={Col} controlId="city" md={3}>
            ...
            <Form.Group as={Col} controlId="zipcode" md={3}>
            ...
            <Form.Group as={Col} controlId="state" md={3}>
            ...
            <Form.Group as={Col} controlId="country" md={3}>
